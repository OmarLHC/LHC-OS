...
create policy "projects_insert" on public.projects for insert to authenticated using (true);
...
create policy "project_members_insert" on public.project_members for insert to authenticated using (true);
create policy "project_members_delete" on public.project_members for delete to authenticated using (true);

-- Tasks
create policy "tasks_select" on public.tasks for select to authenticated using (true);
create policy "tasks_insert" on public.tasks for insert to authenticated using (true);
